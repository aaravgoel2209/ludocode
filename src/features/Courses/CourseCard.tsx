...
export function CourseCard({ course }: CourseCardProps) {
  ...
  return (
    <button onClick={() => goToCourse()} className="flex active:translate-y-[10px] active:shadow-none hover:cursor-pointer shadow-buttonShadow items-center w-full rounded-2xl bg-ludoGrayLight justify-center">
